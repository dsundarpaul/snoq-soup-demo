...
export default function MerchantResetPasswordPage() {
  ...
  const form = useForm<MerchantResetPasswordInput>({
    resolver: zodResolver(merchantResetPasswordSchema),
    defaultValues: {
      password: "",
      confirmPassword: "",
    },
  ...
  const resetPasswordMutation = useMerchantResetPasswordMutation(token);
          ...
          <CardContent>
            {success ? (
              <div className="text-center py-6">
                ...
                <Link href="/merchant">
                  <Button className="gap-2" data-testid="button-go-to-login">
                    {t("nav.goToLogin")}
                  </Button>
                </Link>
              </div>
